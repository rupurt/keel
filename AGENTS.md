...
Keel is an engine with strict constraints (see [FORMAL_RULES.md](FORMAL_RULES.md)). Your job is to perform "tactical moves" that push work through the state machine while eliminating drift.
