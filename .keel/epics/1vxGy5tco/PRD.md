...
|--------|--------|-------------|
| [1vxGzV3oR](voyages/1vxGzV3oR/) | draft | Canonicalize template tokens and align creation CLI ownership contracts. |
| [1vxGzVpw5](voyages/1vxGzVpw5/) | draft | Enforce hard coherency checks in doctor and story lifecycle transitions. |
<!-- END VOYAGES -->
