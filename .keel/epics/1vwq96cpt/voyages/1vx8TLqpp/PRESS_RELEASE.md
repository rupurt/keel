# PRESS RELEASE: Normalize Physical DDD Module Layout
...
## Key Insights
### Insights from Remove Legacy Roots And Enforce Normalized Contracts
...
### Insights from Relocate Infrastructure Services Into Src Infrastructure
...
### Insights from Relocate Cli Command Surface Into Src Cli
...
### Insights from Relocate Domain Core Modules Into Src Domain
...
## Verification Proof
### Proof for Remove Legacy Roots And Enforce Normalized Contracts
...
### Proof for Relocate Infrastructure Services Into Src Infrastructure
...
### Proof for Relocate Cli Command Surface Into Src Cli
...
### Proof for Relocate Domain Core Modules Into Src Domain
