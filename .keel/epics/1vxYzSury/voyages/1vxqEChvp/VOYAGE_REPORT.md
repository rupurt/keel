...
#### Acceptance Criteria
- [x] [SRS-01/AC-01] `keel story new` creates unscoped and scoped stories with `status: done` in persisted frontmatter by default. <!-- verify: cargo test --lib story_new_defaults_to_icebox, SRS-01:start:end, proof: ac-1.log-->
