...
|--------|--------|-------------|
| [1vxqN5jnA](voyages/1vxqN5jnA/) | done | Build catalog model, config overrides, and autodetection/recommendation engine. |
| [1vxvFrNta](voyages/1vxvFrNta/) | done | Complete command-surface cutover to canonical config/verify interfaces. |
<!-- END VOYAGES -->
