...
- [ ] [SRS-02/AC-02] [SRS-NFR-03/AC-01] Non-canonical or legacy goal tokens fail hard without compatibility aliases. <!-- verify: cargo test -p keel goal_lineage_rejects_legacy_tokens, SRS-NFR-03:start:end -->
