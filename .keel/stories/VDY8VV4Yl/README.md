...
- [ ] [SRS-01/AC-03] `BoardStore::load` correctly loads a `Board` aggregate. <!-- verify: cargo test -p keel filesystem_board_store, SRS-01:end -->
- [ ] [SRS-01/AC-04] `BoardStore::save` correctly persists board entities to disk. <!-- verify: cargo test -p keel filesystem_board_store, SRS-01:continues -->
