...
- [ ] [SRS-02/AC-02] [SRS-NFR-01/AC-01] Identical `epic new --problem` inputs yield deterministic scaffold output. <!-- verify: cargo test -p keel epic_problem_scaffold_is_deterministic, SRS-NFR-01:start:end, SRS-02:end -->
