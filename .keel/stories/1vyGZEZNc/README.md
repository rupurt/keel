...
- [ ] [SRS-04/AC-01] Doctor diagnostics report PRD-to-SRS lineage problems using the same coherence rules used by planning transitions. <!-- verify: cargo test -p keel doctor_and_gate_share_prd_lineage_rules, SRS-04:start -->
