...
- [x] [SRS-01/AC-01] `ASSESSMENT.md` requires canonical evidence citations for findings, dependencies, alternatives, and recommendations so assessment claims are traceable to stored source IDs. <!-- verify: cargo test -p keel bearing_assessment_requires_evidence_citations, SRS-01:start, proof: ac-1.log-->
