# Formal Rules of the Keel Engine

> The operational invariants and constraints that govern the Agentic SDLC Simulator.
...
## 3. The Transition State Machine
...
## 4. Priority Ranking (The `calculate_next` Logic)
...
- At least one manual `LOG.md` entry exists summarizing the achievement.
