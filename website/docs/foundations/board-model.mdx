---
title: Keel Board Model
sidebar_label: Board Model
...
2. [Roles And Lanes](/docs/foundations/roles-and-lanes) explains who is allowed to move that structure.
3. [The Turn Loop](/docs/workflows/turn-loop) explains how those moves create visible state change over time.
...
The next question is who is allowed to make those moves. Read [Roles And Lanes](/docs/foundations/roles-and-lanes) next to see how Keel separates strategic authority from delivery execution without splitting the board into separate systems.
