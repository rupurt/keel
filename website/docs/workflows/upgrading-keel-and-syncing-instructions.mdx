...
This is also where small-but-important behavioral changes show up. For example, upstream may tighten or relax heartbeat semantics, hook behavior, or commit-boundary hygiene. Those changes belong in your downstream copies of `AGENTS.md` and `INSTRUCTIONS.md`, not in tribal memory.
