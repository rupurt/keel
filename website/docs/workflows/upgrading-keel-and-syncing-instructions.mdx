...
export const upgradeSteps = [
  ...
  },
  {
    ...
    body:
      'Upgrade Keel the same way your repository installed it: release artifact, Nix input, source build, or pinned contributor toolchain.',
  },
  {
    label: 'Diff',
...
- Source-driven repo: rebuild or reinstall from the desired commit or release tag.
- Release-artifact repo: replace the pinned binary or installer version.
