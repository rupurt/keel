...
Installing the binary is only the first layer. A downstream repository still needs local `AGENTS.md` and `INSTRUCTIONS.md` files that teach humans and agents how to use Keel as that repo's project-management engine.
