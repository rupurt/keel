...
└──────────┴────( \                       / )────┴──────────┘
    ...
    reads: [
      ...
      'Doctor structural pass/fail before the circuit is allowed to energize.',
    ...
    states: [
      ...
      },
      {
        label: 'Short circuit',
        detail:
          'If doctor detects structural errors, the power scene flips to the unhealthy state instead of pretending delivery can continue.',
      },
      {
        label: 'Battery packs',
        detail:
