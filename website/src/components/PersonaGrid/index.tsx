...
const items = [
  {
    ...
    body: "Learn how to create clean arcs, manage lanes, and pull the right signals before asking the team for another move.",
  ...
  },
  {
    ...
    body: "Use stories, evidence, verification, and routines without needing a separate system for engineering coordination.",
  ...
  },
  {
    ...
    body: "Work through bearings, review loops, and story evidence so design work stays visible and enforceable.",
  ...
  },
  {
    ...
    body: "Marketers, lawyers, general managers, and executives can use the same board to review scope, risk, and readiness.",
...
export default function PersonaGrid({ tone = "docs" }: PersonaGridProps) {
  return <SignalGrid items={items} columns="two" tone={tone} />;
}
